#
# Be sure to run `pod lib lint IFreePlayLoginSDK.podspec' to ensure this is a
...
TODO: Add long description of the pod here.
  ...
  s.source           = { :git => 'https://github.com/zhengyachao/IFreePlayLoginSDK.git', :tag => s.version.to_s }
